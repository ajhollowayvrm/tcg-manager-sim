...
| `struct.overprintDeaths` | structural | 15 – 95 | 47 | pass |
| `struct.debtSpiralDeaths` | structural | 15 – 90 | 64 | pass |
...
| `diff.botsAlwaysSurvive` | difficulty | 3 – 11 | 5 | pass |
| `diff.botsNeverSurvive` | difficulty | 2 – 8 | 5 | pass |
| `diff.conservativeSurvives` | difficulty | 0.95 – 1 | 0.95 | pass |
| `diff.licensorEarns` | difficulty | 1.3 – 2.5 | 1.486 | pass |
...
| `diff.deathsLandMidRun` | difficulty | 3 – 25 | 10.08 | pass |
| `diff.sellThrough` | difficulty | 0.75 – 0.95 | 0.9494 | pass |
| `diff.flopRate` | difficulty | 0.01 – 0.25 | 0.0143 | pass |
| `shape.median` | shape | 0.2 – 0.5 | 0.22 | pass |
| `shape.under1` | shape | 0.64 – 0.92 | 0.8107 | pass |
| `shape.under25c` | shape | 0.25 – 0.8 | 0.5393 | pass |
| `shape.top1` | shape | 0.21 – 0.62 | 0.344 | pass |
| `shape.top10` | shape | 0.66 – 0.95 | 0.7699 | pass |
| `shape.gini` | shape | 0.72 – 0.98 | 0.8288 | pass |
| `shape.chaseOverMedian` | shape | 130 – 3100 | 343.8 | pass |
...
| `sub.signalLow` | subsystem | 0.3 – 0.72 | 0.4717 | pass |
| `sub.signalHigh` | subsystem | 0.55 – 0.9 | 0.6744 | pass |
| `sub.signalRises` | subsystem | 0.08 – 0.55 | 0.2028 | pass |
| `sub.gem10Premium` | subsystem | 2 – 5.5 | 4.087 | pass |
| `sub.gradedPrintingShare` | subsystem | 0.02 – 0.09 | 0.0545 | pass |
| `sub.gemRate` | subsystem | 0.3 – 0.6 | 0.5131 | pass |
| `sub.gemRateByQuality` | subsystem | 1.3 – 2 | 1.719 | pass |
