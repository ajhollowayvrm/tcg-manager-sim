...
| `struct.channelCollapseDeaths` | structural | 0.02 – 0.175 | 0.05 | pass |
| `struct.attentionCollapseDeaths` | structural | 0.02 – 0.15 | 0.036 | pass |
...
| `struct.printRunVaries` | structural | 4 – 100 | 28 | pass |
| `diff.botsAlwaysSurvive` | difficulty | 3 – 11 | 10 | pass |
...
| `shape.chaseOverMedian` | shape | 130 – 3100 | 344.6 | pass |
...
| `sub.signalRises` | subsystem | 0.08 – 0.55 | 0.1716 | pass |
