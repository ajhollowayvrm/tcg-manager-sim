...
static.typecheck                1         [1, 1]            pass        PASS     
  ...
  struct.speculatorMoves          2.910     [1.2, 500]        pass        PASS     
  struct.heatNotPinned            0         [0, 0.1]          pass        PASS     
  struct.ripRationBinds           0.653     [0.2, 0.95]       pass        PASS     
  ...
  sub.signalRises                 0.396     [0.08, 0.55]      pass        PASS     
  sub.gem10Premium                3.929     [2, 5.5]          pass        PASS     
  sub.gradedPrintingShare         0.047     [0.02, 0.09]      pass        PASS     
  sub.gemRate                     0.521     [0.3, 0.6]        pass        PASS     
  sub.gemRateByQuality            1.704     [1.3, 2]          pass        PASS     
  sub.gemRateVintage              0.397     [0.15, 0.45]      pass        PASS     
  sub.scalperCycles               4         [3, 35]           pass        PASS     
  sub.scalperShare                0.132     [0.1, 0.5]        pass        PASS     
