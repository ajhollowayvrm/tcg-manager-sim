...
static.typecheck                1         [1, 1]            pass        PASS     
  ...
  struct.speculatorMoves          2.894     [1.2, 500]        pass        PASS     
  ...
  shape.under1                    0.804     [0.64, 0.92]      pass        PASS     
  shape.under25c                  0.536     [0.25, 0.8]       pass        PASS     
  shape.top1                      0.343     [0.21, 0.62]      pass        PASS     
  shape.top10                     0.773     [0.66, 0.95]      pass        PASS     
  shape.gini                      0.833     [0.72, 0.98]      pass        PASS     
  shape.chaseOverMedian           326.7     [130, 3100]       pass        PASS     
  shape.tailAlpha                 1.962     [1.6, 2.7]        pass        PASS     
  shape.ageCurveDirection         0.075     [0.02, 0.45]      pass        PASS     
  shape.ageCurveLate              0.854     [0.55, 0.92]      pass        PASS     
  ...
  sub.gem10Premium                6.134     [2, 5.5]          known-fail  KNOWN    
  sub.gradedPrintingShare         0.046     [0.02, 0.09]      pass        PASS     
  sub.gemRate                     0.100     [0.3, 0.6]        known-fail  KNOWN    
  sub.scalperCycles               4         [3, 35]           pass        PASS     
  sub.scalperShare                0.131     [0.1, 0.5]        pass        PASS     
