...
static.typecheck                1         [1, 1]            pass        PASS     
  ...
  struct.overprintDeaths          82        [15, 95]          pass        PASS     
  struct.debtSpiralDeaths         81        [15, 90]          pass        PASS     
  struct.channelCollapseDeaths    12        [8, 70]           pass        PASS     
  struct.attentionCollapseDeaths  20        [8, 60]           pass        PASS     
  struct.speculatorMoves          3.641     [1.2, 500]        pass        PASS     
  ...
  diff.sellThrough                0.879     [0.75, 0.95]      pass        PASS     
  diff.flopRate                   0.029     [0.01, 0.25]      pass        PASS     

  shape.median                    0.260     [0.2, 0.5]        pass        PASS     
  shape.under1                    0.793     [0.64, 0.92]      pass        PASS     
  shape.under25c                  0.504     [0.25, 0.8]       pass        PASS     
  shape.top1                      0.337     [0.21, 0.62]      pass        PASS     
  shape.top10                     0.765     [0.66, 0.95]      pass        PASS     
  shape.gini                      0.827     [0.72, 0.98]      pass        PASS     
  shape.chaseOverMedian           330.7     [130, 3100]       pass        PASS     
  shape.tailAlpha                 1.992     [1.6, 2.7]        pass        PASS     
  shape.ageCurveDirection         0.082     [0.02, 0.45]      pass        PASS     
  shape.ageCurveLate              0.804     [0.55, 0.92]      pass        PASS     
  shape.surpriseGrail             1         [0.1, 0.6]        known-fail  KNOWN    
  shape.yearsTo100                2.442     [2, 9]            pass        PASS     

  sub.signalLow                   0.430     [0.3, 0.72]       pass        PASS     
  sub.signalHigh                  0.825     [0.65, 0.97]      pass        PASS     
  sub.signalRises                 0.395     [0.08, 0.55]      pass        PASS     
  sub.gem10Premium                6.082     [2, 5.5]          known-fail  KNOWN    
  sub.gradedPrintingShare         0.048     [0.02, 0.09]      pass        PASS     
  sub.gemRate                     0.102     [0.3, 0.6]        known-fail  KNOWN    
  sub.scalperCycles               0         [3, 35]           known-fail  KNOWN    
  sub.scalperShare                0.000     [0.1, 0.5]        known-fail  KNOWN    
