...
3. **A card illustration pays $400–$2,500 flat, no royalty, and the fee does not rise with fame.** Ours is $75–$450, rising up to 250% with reputation — the opposite direction. [documented] **[Round 7, 2026-09-05] Half done, deliberately.** The direction is fixed: `art.rateGrowthPerReputation` is 2.5 -> 0.15, and the newcomer band no longer disagrees with the opening band by a factor of a hundred. The *level* is knowingly not matched — the shipped band is $80–$500, a fifth of the researched one. At the researched rates a 280-card set costs $406,000 in art, 81% of the studio's starting capital, and `conservative` and `safeHands` died 8/8 in year 4. AJ's call was to hold art's SHARE of revenue where the research puts it, since our publisher prints 6,000–66,000 units against a real 16,700–248,000 and earns about a fifth as much. **This is the one place the run deviates from decision 2 (measured numbers are ground truth), and it is a scale correction with an expiry: it must shrink toward 1 as Round 10 lifts capital.**
