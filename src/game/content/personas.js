...
// authenticator is soft-spoken and right. Telling them apart over a run is the game.
//
// taste — weights (0..1) over what the persona actually cares about:
//   power     — raw card punch / design loudness
...
export const PERSONAS = [
  ...
  { id: 'p02', name: 'Quietman Quan', type: 'authenticator', reach: 31, credibility: 94,
    taste: { power: 0.6, value: 0.05, art: 0, fairness: 0.7, fun: 0.2 },
    blurb: 'Soft-spoken grader. Small following, but when he says a copy is suspect, it is.' },
  ...
  { id: 'p05', name: 'ChartNorm', type: 'analyst', reach: 47, credibility: 66,
    taste: { power: 0.7, value: 0.1, art: 0, fairness: 0.4, fun: 0.3 },
    blurb: 'Spreadsheet chart-reader. Spots a bubble fast and shares the models.' },

  { id: 'p06', name: 'RageQuit Rocco', type: 'streamer', reach: 78, credibility: 22,
    taste: { power: 0.6, value: 0.1, art: 0, fairness: 0.6, fun: 0.2 },
    blurb: 'Professional outrage. Everything is a scam, everything is dead. Numbers say otherwise.' },

  { id: 'p07', name: 'Dr. Ledger', type: 'analyst', reach: 55, credibility: 88,
    taste: { power: 0.5, value: 0.05, art: 0, fairness: 0.8, fun: 0.3 },
    blurb: 'Academic market analyst. Dry, data-driven, almost never wrong on valuation.' },
  ...
  { id: 'p09', name: 'Slabwatch Tariq', type: 'authenticator', reach: 69, credibility: 76,
    taste: { power: 0.7, value: 0.2, art: 0, fairness: 0.5, fun: 0.4 },
    blurb: 'Certification regular with a channel. Reliable read on a card’s real population, decent reach.' },
  ...
  { id: 'p13', name: 'Spike Sorensen', type: 'authenticator', reach: 44, credibility: 81,
    taste: { power: 0.8, value: 0.1, art: 0, fairness: 0.6, fun: 0.2 },
    blurb: 'Win-at-all-costs grader. First to spot a manufactured-scarcity claim, loudest to demand a pull.' },
  ...
  { id: 'p15', name: 'The Archivist', type: 'reviewer', reach: 36, credibility: 90,
    ...
    blurb: 'Long-game historian. Low reach, gold-standard credibility on design loudness.' },
  ...
  { id: 'p17', name: 'GrindstoneGail', type: 'analyst', reach: 50, credibility: 72,
    taste: { power: 0.6, value: 0.15, art: 0, fairness: 0.55, fun: 0.35 },
    blurb: 'Chart-obsessed list-builder. Solid reads, posts the price history to back them.' },

  { id: 'p18', name: 'Captain Combo', type: 'analyst', reach: 67, credibility: 57,
  ...
  { id: 'p19', name: 'Old Guard Odell', type: 'reviewer', reach: 29, credibility: 91,
    ...
    blurb: 'Played since the first set. Quiet now, but design loudness makes his blood boil.' },
  { id: 'p20', name: 'Retired Rin', type: 'authenticator', reach: 34, credibility: 86,
    taste: { power: 0.6, value: 0.2, art: 0.1, fairness: 0.7, fun: 0.3 },
    blurb: 'Former pro grader. Drops in to call out a shady print run, then vanishes.' },
  ...
  { id: 'p22', name: 'DigestDaily Maya', type: 'reviewer', reach: 81, credibility: 41,
  ...
  { id: 'p23', name: 'Budget Benny', type: 'analyst', reach: 58, credibility: 63,
    taste: { power: 0.6, value: 0.5, art: 0.05, fairness: 0.5, fun: 0.5 },
    blurb: 'Brews value picks on a shoestring. Champions the cheap common; resents the paywall chase.' },
  ...
  { id: 'p29', name: 'TryhardTeo', type: 'streamer', reach: 72, credibility: 52,
    ...
    blurb: 'Grinds pulls live for the highlight reel. Decent reads between the rage.' },
  ...
  { id: 'p31', name: 'ClipFarm Kai', type: 'streamer', reach: 79, credibility: 26,
    ...
    blurb: 'Lives for the viral clip. Will declare anything a scam if it makes a good 30 seconds.' },

  // More authenticators / graders.
  { id: 'p32', name: 'Meticulous Mei', type: 'authenticator', reach: 40, credibility: 89,
    taste: { power: 0.7, value: 0.1, art: 0, fairness: 0.7, fun: 0.2 },
    blurb: 'Methodical authenticator. Her population-report breakdowns are the ones other graders quietly copy.' },
  { id: 'p33', name: 'AllIn Alvarez', type: 'authenticator', reach: 57, credibility: 51,
    taste: { power: 0.85, value: 0.1, art: 0, fairness: 0.3, fun: 0.5 },
    blurb: 'High-variance grader. Overhypes his pet theory; sometimes it’s actually right.' },
  { id: 'p34', name: 'Coach Calloway', type: 'authenticator', reach: 62, credibility: 70,
    taste: { power: 0.65, value: 0.15, art: 0, fairness: 0.6, fun: 0.35 },
    blurb: 'Veteran authenticator with a podcast. Measured, respected, moves the collector base.' },
  { id: 'p35', name: 'Rookie Reyna', type: 'authenticator', reach: 38, credibility: 45,
  ...
  // More analysts.
  { id: 'p42', name: 'SolveItSeb', type: 'analyst', reach: 51, credibility: 84,
    taste: { power: 0.7, value: 0.05, art: 0, fairness: 0.6, fun: 0.3 },
    blurb: 'Spots a manufactured-scarcity pattern the week a set drops. When Seb calls it, it’s real.' },
  { id: 'p43', name: 'JankLord Jude', type: 'analyst', reach: 60, credibility: 39,
    taste: { power: 0.6, value: 0.1, art: 0.1, fairness: 0.2, fun: 0.9 },
    blurb: 'Brews beautiful nonsense theories. Mostly wrong; every so often, a real sleeper call.' },
  { id: 'p44', name: 'DataDiv Dana', type: 'analyst', reach: 48, credibility: 87,
    taste: { power: 0.5, value: 0.2, art: 0, fairness: 0.85, fun: 0.25 },
    blurb: 'Publishes the population numbers. The one everyone cites in the authenticity debate.' },
  ...
  { id: 'p46', name: 'Provenance Tess', type: 'authenticator', reach: 54, credibility: 77,
    taste: { power: 0.7, value: 0.15, art: 0, fairness: 0.6, fun: 0.3 },
    blurb: 'Runs the biggest community pop-report meetups. Her authentication breakdowns are gospel.' },
  { id: 'p47', name: 'Penny Pincher Pat', type: 'analyst', reach: 42, credibility: 58,
    taste: { power: 0.55, value: 0.6, art: 0.05, fairness: 0.5, fun: 0.5 },
    blurb: 'Budget market analyst. Finds the $2 common that quietly outperforms the chase.' },
  { id: 'p48', name: 'Vintage Vera', type: 'collector', reach: 47, credibility: 75,
    ...
    blurb: 'Old-set collector. Pulled-from-print sets and reprints are personal drama on her shelf.' },
  ...
  { id: 'p50', name: 'Fair Play Farah', type: 'reviewer', reach: 56, credibility: 83,
    ...
    blurb: 'Fair-print crusader. Celebrates an honest catalog; scathing about a manufactured-scarcity play.' },
