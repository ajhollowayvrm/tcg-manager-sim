...
export function useGame() {
  ...
  // A CAST MEMBER — the IP, with no card and no form. See people.js.
  const addPerson = useCallback((name, identity) => dispatch({ type: 'ADD_PERSON', name, identity }), [])
